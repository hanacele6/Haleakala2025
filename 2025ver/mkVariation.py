...
if __name__ == '__main__':
    ...
    days_to_process = ["20250811", "20250812", "20250813", "20250815", "20250816","20250817","20250819","20250821","20250822","20250823","20250824","20250825","20250827","20250828"]

    base_dir = Path("C:/Users/hanac/University/Senior/Mercury/Haleakala2025/")

    # --- 入力ファイルと出力ファイル ---
    # このスクリプトは、複数の日の結果を一つのファイルにまとめます
    output_filename = base_dir / 'output' / 'DailyVariation_Summary_202508.dat' #ここ変えるでい
    # 位相角補正用のファイル
