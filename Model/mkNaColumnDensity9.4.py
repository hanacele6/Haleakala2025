...
def main_snapshot_simulation():
    ...
    run_name = f"ParabolicHop_{N_LON_FIXED}x{N_LAT}_{mode_str}_DT{int(DT_MOVE)}_0530_Multi_BD0.5_UG_Q2.0_Bouncetau30s_A1.0_LongLT(Fulle)"
    ...
    print(f"🚀 Numba Parallel Engine Active: {layer} (Threads: {numba.get_num_threads()})")
