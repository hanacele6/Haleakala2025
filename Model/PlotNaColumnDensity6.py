...
# ★★★ シミュレーション結果のディレクトリ
output_dir = r"./SimulationResult_202605/ParabolicHop_72x36_NoEq_DT100_0502_BD0.4_U2.7_Q0.27_Bouncetau30s_A1.0_LongLT_CHECK"

# ★★★ プロットモード選択 (シミュレーション側)
# 選択肢: "ALL", "DAYSIDE_TOTAL", "DAWN", "DUSK", "DAWN_OUTER", "DUSK_OUTER", "CSV_ONLY"
# "CSV_ONLY" にすると、シミュレーション結果を計算・プロットせず、CSVのみを比較します。
PLOT_MODE = "CSV_ONLY"
...
if sim_taa is not None or PLOT_MODE == "CSV_ONLY":
    ...
    if SHOW_CSV_OVERLAY or PLOT_MODE == "CSV_ONLY":
        ...
        # --- 凡例の統合処理 ---
        if SHOW_LEGEND:
            if PLOT_MODE != "CSV_ONLY" and not CSV_USE_SHARED_Y_AXIS:
