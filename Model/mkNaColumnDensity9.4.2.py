...
def generate_particles_grid_numba(
    ...
    total_loss_step, frac_psd, frac_td, frac_sws, dt_rem_array, dt_step,
...
def main_snapshot_simulation():
    ...
    run_name = f"ParabolicHop_{N_LON_FIXED}x{N_LAT}_{mode_str}_DT{int(DT_MOVE)}_0609_Multi_BD0.5_UG_Q2.0_Bouncetau30s_A2.0_LongLT(Fulle)_test"
            ...
            while t_curr < t_end_run:  # 🌟 ここから時間ステップのループ
                ...
                if empty_ptr < n_empty:
                    gen_stats = generate_particles_grid_numba(
                        ...
                        total_loss_step, frac_psd, frac_td, frac_sws, dt_rem_array, DT_MOVE,
